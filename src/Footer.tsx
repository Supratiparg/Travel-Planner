        ...
        <div className="grid grid-cols-1 md:grid-cols-4 gap-8">
          <div className="space-y-4">
            ...
            <p className="text-gray-400">
              Discover India's hidden gems with our AI-powered trip planning platform.
            </p>
          ...
          <div>
            ...
            <ul className="space-y-2">
              <li><a href="#" className="text-gray-400 hover:text-white">Premium Subscription</a></li>
              <li><a href="#" className="text-gray-400 hover:text-white">Concierge Service</a></li>
              <li><a href="#" className="text-gray-400 hover:text-white">Exclusive Deals</a></li>
